...
class DNS_App(app_manager.RyuApp):
	#Specifying OpenFlow13 version
	OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

	def __init__(self, *args, **kwargs):
		super(DNS_App, self).__init__(*args, **kwargs)

		#MAC to port mapping for the switch
		self.mac_to_port = {}

		#virtual MAC and IP for the LoadBalancer Application
		self.virtual_ip = "192.168.122.254"
		self.virtual_mac = "10:AA:30:BB:50:CC"
